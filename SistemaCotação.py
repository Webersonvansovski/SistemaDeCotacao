...
label_cotacaomoeda = tk.Label(text='Cotação de 1 moeda especifica', borderwidth=2, relief='solid', fg='white', bg='black')
...
label_selecionardia = tk.Label(text='Selecionar o dia em que deseja pegar a cotação da', anchor='e')
...
label_textocotacao.grid(row=3, column=0, columnspan=2, pady=10, padx=10, sticky='nsew')

botao_pegarcotacao = tk.Button(text='Pegar Cotação', command=pegar_cotacao)
botao_pegarcotacao.grid(row=3, column=2, pady=10, padx=10, sticky='nsew')

# cotação de varias moedas

label_cotacaovariasmoeda = tk.Label(text='Cotação de Múltiplas Moedas', borderwidth=2, relief='solid', fg='white', bg='black')
...
calendario_datainicial = DateEntry(year=2022, locale='pt_br', anchor='e')
calendario_datafinal = DateEntry(year=2022, locale='pt_br', anchor='e')
...
botao_fechar.grid(row=10, column=2, pady=10, padx=10, sticky='nsew')
